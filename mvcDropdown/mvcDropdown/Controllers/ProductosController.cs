...
namespace mvcDropdown.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Precio,Descripcion,CategoriaId")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Precio,Descripcion,CategoriaId")] Producto producto)
        {
            if (id != producto.Id)
            {
                return NotFound();
